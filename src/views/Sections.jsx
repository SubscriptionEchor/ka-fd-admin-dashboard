...
function Sections(props) {
  ...
  const [sectionToDelete, setSectionToDelete] = useState(null); // State to track which banner to delete
  ...
  const columns = [
    ...
    // },
    {
      ...
      cell: row => (
        <Tooltip
          title={row.restaurants.map(item => item.name).join(', ')}
          arrow
          componentsProps={{
            tooltip: {
              sx: {
          ...
          <Paper>
            <Menu
              ...
              <MenuItem
                onClick={e => {
                  e.preventDefault();
                  setSectionToDelete(row); // Set the banner to be deleted
    ...
    <>
      ...
      <Container className={globalClasses.flex} fluid>
        ...
        <DeleteConfirmationDialog
          ...
          description={t('Are you sure you want to delete this Sections?')}
        />
      </Container>
    </>
  )
