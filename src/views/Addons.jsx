...
const Addon = props => {
  ...
  const [addonToDelete, setAddonToDelete] = useState(null); // State to track which banner to delete
          ...
          <Paper>
            <Menu
              ...
              <MenuItem
                onClick={e => {
                  e.preventDefault();
                  setAddonToDelete(row); // Set the banner to be deleted
  ...
  const handleDelete = () => {
    mutate({
      variables: {
        id: addonToDelete._id, restaurant: restaurantId
      }
    })
    ...
    <>
      ...
      <Container className={globalClasses.flex} fluid>
        ...
        <DeleteConfirmationDialog
          ...
          description={t('Are you sure you want to delete this Addons?')}
        />
      </Container>
    </>
  )
