...
const Banners = props => {
  ...
  const [bannerToDelete, setBannerToDelete] = useState(null); // State to track which banner to delete
          ...
          <Paper>
            <Menu
              ...
              <MenuItem
                onClick={e => {
                  e.preventDefault();
                  setBannerToDelete(row); // Set the banner to be deleted
  ...
  const handleDelete = () => {
    mutateDelete({ variables: { id: bannerToDelete._id } });
    ...
    <>
      ...
      <Container className={globalClasses.flex} fluid>
        ...
        <DeleteConfirmationDialog
          ...
          description={t('Are you sure you want to delete this Banner?')}
        />
      </Container>
    </>
  )
