...
const Cuisines = props => {
  ...
  const [cuisineToDelete, setCuisineToDelete] = useState(null); // State to track which banner to delete
  ...
  const columns = [
    ...
    //         style={{ width: 30, height: 30, borderRadius: 15,display:"none" }}
    //         src={
    //           row.image ||
          ...
          <Paper>
            <Menu
              ...
              <MenuItem
                onClick={e => {
                  e.preventDefault();
                  setCuisineToDelete(row); // Set the banner to be deleted
  ...
  const handleDelete = () => {
    mutateDelete({ variables: { id: cuisineToDelete._id } })
    ...
    <>
      ...
      <Container className={globalClasses.flex} fluid>
        ...
        <DeleteConfirmationDialog
          ...
          description={t('Are you sure you want to delete this Cuisines?')}
        />
      </Container>
    </>
  )
