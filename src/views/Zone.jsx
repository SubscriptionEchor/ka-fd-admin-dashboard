...
const Zones = props => {
  ...
  const [zoneToDelete, setZoneToDelete] = useState(null); // State to track which banner to delete
          ...
          <Paper>
            <Menu
              ...
              <MenuItem
                onClick={e => {
                  e.preventDefault();
                  setZoneToDelete(row); // Set the banner to be deleted
  ...
  const handleDelete = () => {
    mutate({ variables: { id: zoneToDelete._id } })
    ...
    <>
      ...
      <Container className={globalClasses.flex} fluid>
        ...
        <DeleteConfirmationDialog
          ...
          description={t('Are you sure you want to delete this Zone?')}
        />
      </Container>
    </>
  )
