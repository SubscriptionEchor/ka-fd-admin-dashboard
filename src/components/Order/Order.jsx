                ...
                <Grid container mb={1} mt={1}>
                  ...
                  <Grid item lg={1}>
                    <Typography
                      ...
                      variant="body1"
                    >
                      <span style={{ fontSize: '0.8rem', fontWeight: 'normal' }}>qty:</span>
                      <span style={{ fontWeight: 'bold' }}>{item.quantity}</span>
                    </Typography>
                  </Grid>
                  <Grid className={classes.textBlack} item lg={9} mt={0.3}>
                    {`${item.title}${item.variation.title ? `(${item.variation.title})` : ''
                      }`}
                  </Grid>
                  {/* <Grid
        ...
        <>
          ...
          <Box className={classes.btnBox}>
            ...
            <Button
              ...
              {order.status === false ? t('Rejected') : t('Reject')}
            </Button>
          </Box>
