...
//     <Box
//       sx={{
//         background: `linear-gradient(237.49deg, ${theme.palette.success.lightest} 0.63%, ${theme.palette.success.darkest} 85.49%)`, display: "none",marginBottom:"2rem"
//       }}
  ...
  return (
    <>
      ...
      <Box sx={{ 
        height: '2rem',
        width: '100%',
        marginTop: '2rem'  // Added top margin for better spacing
      }} />
    </>
  )
}
